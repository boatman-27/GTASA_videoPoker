...
function Button({
  ...
  const styles = {
    primary: `${base} uppercase rounded-lg bg-gray-400 text-stone-800 hover:bg-gray-300 focus:bg-gray-300 px-4 py-2 md:px-6 md:py-4`,
    small: `${base} uppercase rounded-xl bg-gray-400 text-stone-800 hover:bg-yellow-300 focus:bg-yellow-300 px-4 py-2 md:px-5 md:py-2.5 text-xs ${
      isChosen ? "bg-yellow-300" : ""
    }`,
